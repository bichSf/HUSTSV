        ...
        <div class="container">
                ...
                <div class="col-12 col-md-4 col-lg-4 p0">
                    <div class="foot-about">
                        <div id="wrapper-title-left-left" class="map">
                            ...
                            <span>{{ trans('attribute.common.full_school') }}</span>
            ...
            <div class="row flex-wrap justify-content-center justify-content-lg-between align-items-center fs12">
                <span class="footer-copyright color-gray">
                    {{ trans('attribute.index.copyright') }} &copy;<script>document.write(new Date().getFullYear());</script>
                    {{ trans('attribute.index.copy_right') }} by <a class="color-gray" href="https://www.hust.edu.vn/web/vi/home">{{ trans('attribute.common.school') }}</a>
                </span>
            </div>
        </div>
    </div>
